  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="w-full backdrop-blur-sm bg-black/40 border-yellow-400/20 hover:shadow-2xl hover:shadow-yellow-400/20 transition-all duration-600 hover:border-yellow-400/40">
          ...
          <CardFooter className="flex-col space-y-3">
            ...
            <Button 
              variant="outline" 
              className="w-full border-yellow-400/30 text-yellow-400 hover:bg-yellow-400/10 hover:border-yellow-400 hover:text-yellow-300 transition-all duration-600 hover:shadow-2xl hover:shadow-yellow-400/20"
            >
        ...
        <div className="text-center mt-6">
          <p className="text-gray-400 text-sm">
            ...
            <a href="/signup" className="text-yellow-400 hover:text-yellow-300 underline-offset-4 hover:underline font-medium">
              Sign up for MRDB
            </a>
          </p>
        </div>
